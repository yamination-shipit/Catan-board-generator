...
date: 2026-06-15
last_updated: 2026-06-15T16:45:56Z
...
| --------------------- | --------------------------------------------------- |
| `just check`          | Pass                                                |
| `just test`           | Pass, 16 domain tests                               |
| `just test-honeycomb` | Pass, browser copy/toggle/highlight/mobile coverage |
| `just ci`             | Pass                                                |
...
Implemented on `codex/ui-rules-port-fixes`. A separate follow-up plan
`.plans/20260615-1612-planned-expansion-generation.md` covers real expansion generation with
intentionally breaking seed compatibility and a new ADR.
