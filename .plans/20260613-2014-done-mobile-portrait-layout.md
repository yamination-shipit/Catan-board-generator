...
- Add mobile portrait rules for single-column controls, stable board height, and stacked option
  grids.
...
- `just test-honeycomb`
- `just ci`
- Manual Pixel 5 Chromium render at `http://127.0.0.1:8080/`: document client width, document scroll
  width, and body scroll width all measured `393px`.
