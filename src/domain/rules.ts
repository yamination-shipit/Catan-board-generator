...
export const PORTS: readonly Port[] = [
  ...
  { type: "brick", hexRow: 4, hexCol: 1, vertices: [2, 3], label: "2:1", shortLabel: "Brick" },
...
export const FIVE_SIX_PORTS: readonly Port[] = [
  ...
  { type: "3:1", hexRow: 4, hexCol: 4, vertices: [2, 3], label: "3:1", shortLabel: "?" },
  { type: "brick", hexRow: 6, hexCol: 2, vertices: [2, 3], label: "2:1", shortLabel: "Brick" },
  { type: "sheep", hexRow: 6, hexCol: 1, vertices: [3, 4], label: "2:1", shortLabel: "Sheep" },
...
export const SEAFARERS_PORTS: readonly Port[] = [
  ...
  { type: "brick", hexRow: 6, hexCol: 1, vertices: [3, 4], label: "2:1", shortLabel: "Brick" },
